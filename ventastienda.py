...
Npayos=float(input("Ingrese la cantidad  de payasos vendidos en el ultimo mes "))
Nbarbies=float(input("Ingrese la cantidad  de muñecas vendidas en el ultimo mes "))
Pbarbies=75 
Ppayasos=112
pesoPayasos=Ppayasos*Npayos
pesobarbies=Pbarbies*Nbarbies
suma=pesobarbies+pesoPayasos
print("el peso total del paquete es de " + str(suma))
